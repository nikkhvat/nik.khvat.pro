    ...
    return (
      <Html lang={currentLocale}>
        <Head title='Nikita Khvatov' >
          ...
          <meta name="keywords" content="React, Next, Developer, Nikita, Khvatov, Portfolio" />
          <meta name="author" content="Nikita Khvatov" />
          <meta name="viewport" content="width=device-width, initial-scale=1.0" />

          <meta property="og:image" content="https://nik19ta.pro/README/prewiew.png" />
          <meta property="og:description" content="My website about me, my services and my portfolio" />
